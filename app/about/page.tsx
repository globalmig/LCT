    ...
    <main className="flex flex-col">
      ...
      >
        ...
        <div className="relative z-10 text-center">
          <p className="mb-4 text-sm font-medium tracking-[0.25em] text-blue-300 uppercase">LCT Holdings</p>
          <h1 className="text-5xl font-bold tracking-tight text-white sm:text-6xl lg:text-7xl">회사소개</h1>
        ...
        <div className="mx-auto max-w-6xl">
          <div className="grid grid-cols-1 gap-16 lg:grid-cols-2">
            ...
            <div className="flex flex-col justify-center">
              <p className="mb-3 text-xs font-semibold tracking-[0.2em] text-blue-600 uppercase">About Us</p>
              <h2 className="mb-6 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">LCT Holdings</h2>
              <div className="space-y-4 text-base leading-8 text-gray-600">
                <p>
                  LCT Holdings는 폴더블 디바이스 리페어 산업을 기반으로 설립된 기술 기반 홀딩스 기업입니다. 빠르게 성장하는 스마트 디바이스 수리 시장에서 독보적인 기술력과 노하우를 바탕으로 산업
                  표준을 선도하고 있습니다.
                </p>
                <p>기술·장비·가맹 네트워크를 통합 운영하는 플랫폼 구조를 통해 파트너사에 체계적인 솔루션을 제공하며, 수리 산업의 전 과정을 표준화하고 있습니다.</p>
                <p>자체 개발한 LCTech 기술을 기반으로 차세대 리페어 산업 표준을 구축하고, BRICKSTECH 플랫폼을 통해 전국 파트너 네트워크와 긴밀히 연결됩니다.</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-6">
              {[
                ...
                <div key={stat.label} className="flex flex-col items-center justify-center rounded-2xl border border-gray-100 bg-gray-50 p-8 text-center">
      ...
      <section style={{ background: "#F8FAFC" }} className="px-6 py-24">
        <div className="mx-auto max-w-6xl">
          <div className="mb-16 text-center">
            <p className="mb-3 text-xs font-semibold tracking-[0.2em] text-blue-600 uppercase">Services</p>
            <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">제공 서비스</h2>
          </div>
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              {
                title: "표준 공정 매뉴얼 제공",
                desc: "LCTech Holdings가 자체 개발한 표준 공정 매뉴얼로 균일한 서비스 품질을 전국 어디서나 유지합니다.",
                icon: (
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                    <path
              ...
              <div key={service.title} className="group rounded-2xl border border-gray-100 bg-white p-8 shadow-sm transition-all duration-300 hover:border-blue-100 hover:shadow-md">
      ...
      {/* 기술 및 특허 */}
      <section style={{ background: "#050A18" }} className="px-6 py-24">
        <div className="mx-auto max-w-6xl">
          <div className="mb-16 text-center">
            <p className="mb-3 text-xs font-semibold tracking-[0.2em] text-blue-400 uppercase">Technology & Patents</p>
            <h2 className="text-3xl font-bold tracking-tight text-white sm:text-4xl">LCTech 융합 세정 기술</h2>
            <p className="mx-auto mt-4 max-w-2xl text-base leading-8 text-gray-400">자체 특허 보유 기술을 바탕으로 폴더블 디스플레이 수리의 새로운 기준을 제시합니다.</p>
          </div>
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
            {[
              ...
              <div key={tech.title} className="rounded-2xl border p-8" style={{ borderColor: "#2563EB", background: "rgba(37,99,235,0.06)" }}>
                <span className="mb-4 inline-block rounded-full px-3 py-1 text-xs font-semibold tracking-wide" style={{ background: "rgba(37,99,235,0.2)", color: "#93C5FD" }}>
                  {tech.badge}
                </span>
      ...
      >
        <div className="mx-auto max-w-4xl text-center">
          <p className="mb-3 text-xs font-semibold tracking-[0.2em] text-blue-200 uppercase">Platform</p>
          <h2 className="mb-6 text-3xl font-bold tracking-tight text-white sm:text-4xl">BRICKSTECH</h2>
          <p className="mx-auto mb-8 max-w-2xl text-base leading-8 text-blue-100">
            BRICKSTECH는 LCT Holdings의 장비·기술·가맹을 하나로 연결하는 통합 플랫폼입니다. FoldCare는 BRICKSTECH가 제공하는 폴더블 케어 서비스이며, 파트너사는 BRICKSTECH를 통해 수리 장비 관리, 기술
            교육, 자재 주문, 운영 시스템을 단일 채널에서 원스톱으로 이용할 수 있습니다.
          </p>
          ...
          <div className="mb-12 grid grid-cols-1 gap-4 sm:grid-cols-3">
            {[
              ...
              <div key={item.label} className="rounded-xl p-6" style={{ background: "rgba(255,255,255,0.12)" }}>
