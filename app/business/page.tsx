...
const businessAreas = [
  {
    ...
    description:
      "LCT Holdings는 폴더블 스마트폰을 비롯한 차세대 디바이스의 디스플레이 수리에 특화된 고정밀 장비를 자체 개발합니다. 자동화 수리 시스템을 통해 기술 숙련도와 관계없이 일관된 품질의 서비스를 구현합니다.",
    bullets: [
      "폴더블 디스플레이 전용 리페어 장비 설계·제조",
      "자동화 수리 시스템으로 공정 효율 극대화",
      "파트너사 전용 장비 공급 및 유지보수 지원",
      "지속적인 장비 업그레이드 및 기술 지원",
    ],
    bg: "white",
  },
  {
    ...
    description:
      "자체 보유한 LCTech 특허 기술을 라이선스 방식으로 제공하여 파트너사의 기술 경쟁력을 높입니다. 표준화된 공정 시스템과 체계적인 교육 프로그램을 통해 서비스 품질을 균일하게 유지합니다.",
    bullets: [
      "융합 세정 및 무손상 분리 기술 라이선스 제공",
      "표준 공정 매뉴얼 및 운영 가이드라인 공급",
      "현장 중심 기술 교육 및 자격 인증 프로그램",
      "기술 변화에 대응하는 정기 업데이트 지원",
    ],
    bg: "gray",
  },
  {
    ...
    bullets: [
      "전국 리페어 가맹 네트워크 구축 및 운영",
      "장비·자재 통합 공급 채널 제공",
      "로열티 기반 수익 배분 구조",
      "BRICKSTECH 플랫폼을 통한 원스톱 운영 관리",
    ],
    bg: "white",
  },
  {
    ...
    description:
      "손상된 폴더블 디스플레이를 복원·재사용하는 리퍼비시 사업을 통해 전자 폐기물을 줄이고 ESG 경영 가치를 실현합니다. 자원 순환 경제 모델로 지속 가능한 비즈니스 생태계를 구축합니다.",
    bullets: [
      "폴더블 디스플레이 복원 및 리퍼비시 처리",
      "전자 폐기물 감소를 통한 환경 부담 최소화",
      "ESG 지표 개선 및 지속가능경영 지원",
      "친환경 공정 인증 추진 및 탄소중립 로드맵",
    ],
    bg: "gray",
  },
  {
    ...
    bullets: [
      "폴더블 태블릿 디스플레이 수리 기술 개발",
      "노트북 OLED 디스플레이 리페어 솔루션",
      "차량용 디스플레이(IVI) 수리 시장 진출",
      "글로벌 시장 진출을 위한 기술 표준화 추진",
    ],
    bg: "white",
  },
];
    ...
    <main className="flex flex-col">
      ...
      <section className="bg-white px-6 py-24">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto max-w-3xl text-base leading-9 text-gray-600">
            LCT Holdings는 폴더블 디바이스 리페어 생태계를 구성하는 5개의 핵심 사업 영역을 운영합니다.
            장비 개발부터 기술 라이선스, 프랜차이즈 플랫폼, 친환경 리퍼비시, 미래 확장 사업까지
            리페어 산업 전 밸류체인을 통합 관리하여 지속 가능한 성장을 추구합니다.
          </p>
      ...
      {businessAreas.map((area) => (
        <section
          key={area.number}
          id={`area-${area.number}`}
          style={{ background: area.bg === "gray" ? "#F8FAFC" : "#FFFFFF" }}
          ...
          <div className="mx-auto max-w-6xl">
            <div className="grid grid-cols-1 gap-12 lg:grid-cols-[1fr_2fr]">
              ...
              <div className="flex flex-col justify-start pt-2">
                <span
                  className="select-none font-mono text-[6rem] font-black leading-none tracking-tighter lg:text-[8rem]"
                  style={{ color: "#1428A0", opacity: 0.15 }}
                  aria-hidden="true"
                >
                  {area.number}
                </span>
              ...
              {/* Right: 내용 */}
              <div>
                <p className="mb-2 text-xs font-semibold tracking-[0.2em] text-blue-500 uppercase">
                  Business Area
                </p>
      ...
      >
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mx-auto mb-10 max-w-xl text-base leading-8 text-blue-100">
            LCT Holdings와 함께 리페어 산업의 미래를 열어가실 파트너를 찾습니다.
            사업 제휴, 가맹 문의, 기술 라이선스 등 모든 파트너십 관련 문의를 환영합니다.
          </p>
          <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
            ...
            <Link
              href="/about"
              className="inline-flex items-center gap-2 rounded-full px-8 py-3.5 text-sm font-semibold text-blue-100 transition-all duration-200 hover:text-white"
            >
              회사소개 보기
            </Link>
          </div>
